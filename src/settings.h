...
#define KOL_LED       60 * 5         // Сколько светодиодов в гирлянде при первом включении
...
#define IR_MAX_LEDS   KOL_LED         // Максимальное количество светодиодов при работе с пультом должно быть больше
// или равно KOL_LED
...
#define POWER_I       18000        // Ток блока питания в милиАмперах
